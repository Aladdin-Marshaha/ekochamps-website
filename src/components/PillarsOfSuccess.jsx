...
const PillarsOfSuccess = () => {
  const pillars = [
    {
      id: 1,
      image: '/ekochamps-website/images/hero-background.jpg',
    ...
    {
      id: 2,
      image: '/ekochamps-website/images/hands-background.jpg',
    ...
    {
      id: 3,
      image: '/ekochamps-website/images/school-kids-background.jpg',
    ...
    {
      id: 4,
      image: '/ekochamps-website/images/app-mockup.jpg',
